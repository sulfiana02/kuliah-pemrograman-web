...
<head>
    ...
    <title>Kontak - Toko Sembako Anti</title>
...
<body class="bg-slate-50 font-inter">
        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex space-x-8 items-center">
                    ...
                    <a href="/kontak" class="text-blue-600 font-medium relative after:content-[''] after:absolute after:w-full after:h-0.5 after:bg-blue-500 after:-bottom-1 after:left-0">Kontak</a>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div>
                        ...
                        <form 
                            ...
                            id="contact-form"
                        >
                            <!-- Input tersembunyi untuk konfigurasi FormSubmit -->
                        ...
                        <!-- Alternatif: Jika FormSubmit tidak bekerja, gunakan mailto -->
    ...
    <script>
        ...
        // Untuk halaman kontak, tambahkan notifikasi bahwa keranjang tersedia di halaman produk
        cartIcons.forEach(icon => {
